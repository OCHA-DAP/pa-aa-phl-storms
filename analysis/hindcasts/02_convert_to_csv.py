...
save_dir = Path(os.environ["HINDCAST_DIR"])

# TODO: add latest typhoons
filename = (
    "https://github.com/rodekruis/Typhoon-Impact-based-"
    "forecasting-model/blob/master/data/typhoon_events.csv"
)
