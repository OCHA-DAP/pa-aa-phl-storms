...
output:
  html_document:
    css: aa_phl_storms_trigger_report_template/docs/style.css
    includes:
      in_header: aa_phl_storms_trigger_report_template/docs/header.html
    toc: no
    toc_float: yes
    toc_depth: '4'
    df_print: paged
...
explanatory_ci_plot_path <- ("aa_phl_storms_trigger_report_template/docs/explanatory_ci.png")
```

```{r functions}
source("aa_phl_storms_trigger_report_template/docs/plotAtvCI.R")
source("aa_phl_storms_trigger_report_template/docs/plotTradeoffCI.R")
```
